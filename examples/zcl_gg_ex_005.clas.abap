...
* zgg_ex_005.prog.abap. Self contained: no superclass, every callback present.
...
CLASS zcl_gg_ex_005 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_005' description = 'FORMAT color and attributes' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_005' ).
