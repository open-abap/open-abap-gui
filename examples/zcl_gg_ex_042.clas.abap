...
* Feature 42, MESSAGE DISPLAY LIKE. Counterpart of zgg_ex_042.prog.abap.
...
CLASS zcl_gg_ex_042 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_042' description = 'MESSAGE DISPLAY LIKE' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_042' ).
