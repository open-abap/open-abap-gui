...
* Feature 07, REPORT line settings. Counterpart of zgg_ex_007.prog.abap.
* The print/spool half remains blocked by gap #6. Self contained: no
...
CLASS zcl_gg_ex_007 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_007' description = 'REPORT line settings' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_007' ).
