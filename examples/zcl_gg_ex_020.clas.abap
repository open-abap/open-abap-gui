CLASS zcl_gg_ex_020 DEFINITION PUBLIC FINAL CREATE PUBLIC.

* Feature 20, SELECT-OPTIONS. Counterpart of zgg_ex_020.prog.abap.
...
CLASS zcl_gg_ex_020 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_020' description = 'SELECT-OPTIONS' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_020' ).
    RETURN.
  ENDMETHOD.
