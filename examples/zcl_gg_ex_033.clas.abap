...
* zgg_ex_033.prog.abap. The host drives block-level PAI before general PAI.
...
CLASS zcl_gg_ex_033 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_033' description = 'AT SELECTION-SCREEN ON BLOCK' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_033' ).
    RETURN.
  ENDMETHOD.
