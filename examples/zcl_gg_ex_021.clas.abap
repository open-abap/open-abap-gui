...
* zgg_ex_021.prog.abap. The host retains literal comment structure.
...
CLASS zcl_gg_ex_021 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_021' description = 'SELECTION-SCREEN COMMENT, ULINE and SKIP' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_021' ).
    RETURN.
  ENDMETHOD.
