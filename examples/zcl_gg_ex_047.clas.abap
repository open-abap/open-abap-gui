...
* Feature 47, GET CURSOR. Counterpart of zgg_ex_047.prog.abap.
* The host supplies cursor context for a requested line selection. Self
* contained: no superclass, every callback present.
...
CLASS zcl_gg_ex_047 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_047' description = 'GET CURSOR' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_047' ).
    RETURN.
  ENDMETHOD.
