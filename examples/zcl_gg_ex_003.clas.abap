...
* zgg_ex_003.prog.abap. Self contained: no superclass, every callback present.
...
CLASS zcl_gg_ex_003 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_003' description = 'SKIP, ULINE, NEW-LINE and SET LEFT COLUMN' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_003' ).
