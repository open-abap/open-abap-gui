...
* zgg_ex_027.prog.abap. The host records named-screen metadata for inspection.
...
CLASS zcl_gg_ex_027 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_027' description = 'Selection-screen BEGIN OF SCREEN' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_027' ).
    RETURN.
  ENDMETHOD.
