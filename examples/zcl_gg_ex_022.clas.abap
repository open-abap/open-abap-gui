...
* zgg_ex_022.prog.abap. The host records block definitions and nesting depth.
...
CLASS zcl_gg_ex_022 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_022' description = 'Selection-screen block with frame and title' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_022' ).
    RETURN.
  ENDMETHOD.
