...
* zgg_ex_016.prog.abap. The host retains the parameter attributes and groups.
...
CLASS zcl_gg_ex_016 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_016' description = 'PARAMETERS attribute additions' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_016' ).
