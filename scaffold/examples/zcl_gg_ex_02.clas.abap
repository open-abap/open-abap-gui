CLASS zcl_gg_ex_02 DEFINITION PUBLIC FINAL CREATE PUBLIC.

* Feature 02, WRITE AT <pos>(<len>) and NO-GAP. Counterpart of
* zgg_ex_02.prog.abap. Self contained: no superclass, every callback present.
*
...
CLASS zcl_gg_ex_02 IMPLEMENTATION.
  ...
  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_02' description = 'WRITE AT position and NO-GAP' ).
  ENDMETHOD.
