CLASS zcl_gg_ex_062 DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_gg_ex_062 IMPLEMENTATION.
  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_062' description = 'Status changes after a command' ).
  ENDMETHOD.
