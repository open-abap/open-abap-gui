...
* Feature 46, READ LINE and MODIFY LINE. Counterpart of zgg_ex_046.prog.abap.
...
CLASS zcl_gg_ex_046 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_046' description = 'READ LINE and MODIFY LINE' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_046' ).
