...
* zgg_ex_028.prog.abap. The host drives selection-screen output and retains state
...
CLASS zcl_gg_ex_028 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_028' description = 'AT SELECTION-SCREEN OUTPUT with LOOP AT SCREEN' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_028' ).
    RETURN.
  ENDMETHOD.
