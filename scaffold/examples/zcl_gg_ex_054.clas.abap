...
* zgg_ex_054.prog.abap. The host forwards selections and retains the variant.
...
CLASS zcl_gg_ex_054 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_054' description = 'SUBMIT AND RETURN with selections and variant' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_054' ).
