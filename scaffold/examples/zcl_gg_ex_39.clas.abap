CLASS zcl_gg_ex_39 DEFINITION PUBLIC FINAL CREATE PUBLIC.

* Feature 39, MESSAGE free text TYPE. Counterpart of zgg_ex_39.prog.abap.
...
CLASS zcl_gg_ex_39 IMPLEMENTATION.
  ...
  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_39' description = 'MESSAGE free text TYPE' ).
  ENDMETHOD.
