...
* zgg_ex_048.prog.abap. The host drives the nested-list page header.
...
CLASS zcl_gg_ex_048 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_048' description = 'TOP-OF-PAGE DURING LINE-SELECTION' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_048' ).
