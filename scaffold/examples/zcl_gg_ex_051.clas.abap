...
* Feature 51, CALL SELECTION-SCREEN. Counterpart of zgg_ex_051.prog.abap.
...
CLASS zcl_gg_ex_051 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_051' description = 'CALL SELECTION-SCREEN' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_051' ).
