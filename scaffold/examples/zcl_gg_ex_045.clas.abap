...
* Feature 45, SET TITLEBAR. Counterpart of zgg_ex_045.prog.abap.
...
CLASS zcl_gg_ex_045 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_045' description = 'SET TITLEBAR' ).
  ENDMETHOD.
