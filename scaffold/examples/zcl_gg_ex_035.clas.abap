...
* zgg_ex_035.prog.abap. The host applies the returned range to the requested field.
...
CLASS zcl_gg_ex_035 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_035' description = 'AT SELECTION-SCREEN ON VALUE-REQUEST' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_035' ).
    RETURN.
  ENDMETHOD.
