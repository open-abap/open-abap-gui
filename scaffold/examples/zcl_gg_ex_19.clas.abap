CLASS zcl_gg_ex_19 DEFINITION PUBLIC FINAL CREATE PUBLIC.

* Feature 19, PARAMETERS AS LISTBOX. Counterpart of zgg_ex_19.prog.abap.
...
CLASS zcl_gg_ex_19 IMPLEMENTATION.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_19' ).
    RETURN.
  ENDMETHOD.
