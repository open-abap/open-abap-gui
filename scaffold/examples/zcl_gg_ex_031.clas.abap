...
* zgg_ex_031.prog.abap. The host drives on-field PAI before general PAI.
...
CLASS zcl_gg_ex_031 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_031' description = 'AT SELECTION-SCREEN ON field' ).
  ENDMETHOD.
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_031' ).
    RETURN.
  ENDMETHOD.
