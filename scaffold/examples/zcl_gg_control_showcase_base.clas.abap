...
CLASS zcl_gg_control_showcase_base IMPLEMENTATION.
  ...
  METHOD build_controls.
    ...
    CASE mv_mode.
      WHEN '117'.
        ...
        DATA(lo_editor117) = NEW cl_gui_textedit( parent = lo_root wordwrap_to_linebreak_mode = 0 ).
        lo_editor117->set_textstream( 'Child control in custom container' ).
        lo_editor117->set_position( left = 20 top = 30 width = 360 height = 80 ).
      WHEN '118'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT118' ).
        DATA(lo_split118) = NEW cl_gui_splitter_container( parent = lo_root rows = 2 columns = 1 ).
        lo_split118->set_position( left = 10 top = 10 width = 500 height = 240 ).
        DATA(lo_nested118) = NEW cl_gui_splitter_container( parent = lo_split118 rows = 1 columns = 2 ).
        DATA(lo_editor118) = NEW cl_gui_textedit( parent = lo_nested118 wordwrap_to_linebreak_mode = 0 ).
        lo_editor118->set_textstream( 'Nested horizontal pane' ).
      WHEN '119'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT119' ).
        DATA(lo_easy119) = NEW cl_gui_easy_splitter_container( parent = lo_root orientation = cl_gui_easy_splitter_container=>orientation_horizontal sash_position = 40 ).
        lo_easy119->set_position( left = 10 top = 10 width = 500 height = 180 ).
        DATA(lo_editor119) = NEW cl_gui_textedit( parent = lo_easy119 wordwrap_to_linebreak_mode = 0 ).
        lo_editor119->set_textstream( 'Easy splitter content' ).
      WHEN '120'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT120' ).
        DATA(lo_dock120) = NEW cl_gui_docking_container( parent = lo_root side = cl_gui_docking_container=>dock_at_right extension = 180 caption = 'Docked tools' ).
        lo_dock120->set_position( left = 330 top = 10 width = 180 height = 160 ).
        DATA(lo_editor120) = NEW cl_gui_textedit( parent = lo_dock120 wordwrap_to_linebreak_mode = 0 ).
        lo_editor120->set_textstream( 'Docked content' ).
      WHEN '121'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT121' ).
        DATA(lo_dialog121) = NEW cl_gui_dialogbox_container( parent = lo_root width = 360 height = 180 caption = 'Dialog content' ).
        DATA(lo_editor121) = NEW cl_gui_textedit( parent = lo_dialog121 wordwrap_to_linebreak_mode = 0 ).
        lo_editor121->set_textstream( 'Modal dialog body' ).
      WHEN '122'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT122' ).
        DATA(lo_editor122) = NEW cl_gui_textedit( parent = lo_root wordwrap_to_linebreak_mode = 0 ).
        ...
        lo_editor122->set_position( left = 20 top = 20 width = 500 height = 150 ).
      WHEN '123'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT123' ).
        DATA(lo_editor123) = NEW cl_gui_textedit( parent = lo_root wordwrap_to_linebreak_mode = 0 ).
        ...
        lo_editor123->set_position( left = 20 top = 20 width = 500 height = 120 ).
      WHEN '124'.
        ...
        lo_picture124->set_position( left = 20 top = 20 width = 180 height = 100 ).
      WHEN '125'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT125' ).
        DATA(lo_toolbar125) = NEW cl_gui_toolbar( parent = lo_root ).
        lo_toolbar125->add_button( fcode = 'RUN' icon = '@' butn_type = 0 text = 'Run' quickinfo = 'Run toolbar action' ).
        lo_toolbar125->add_button( fcode = 'DISABLED' icon = '@' butn_type = 0 text = 'Disabled' quickinfo = 'Disabled action' is_disabled = abap_true ).
        lo_toolbar125->set_position( left = 20 top = 20 width = 260 height = 40 ).
      WHEN '126'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT126' ).
        DATA(lo_calendar126) = NEW cl_gui_calendar( parent = lo_root focus_date = '20260830' ).
        lo_calendar126->set_selection( date_begin = '20260830' date_end = '20260901' ).
        lo_calendar126->set_position( left = 20 top = 20 width = 360 height = 150 ).
      WHEN '127'.
        ...
        lo_selector127->set_options( VALUE #(
          ...
          ( key = 'UA' text = 'United' ) ) ).
        lo_selector127->set_position( left = 20 top = 20 width = 240 height = 30 ).
      WHEN '128'.
        ...
        lo_viewer128->set_position( left = 20 top = 20 width = 500 height = 150 ).
      WHEN '129'.
      ...
      WHEN '131'.
        ...
        DATA(lo_split131) = NEW cl_gui_splitter_container( parent = lo_root rows = 1 columns = 2 ).
        DATA(lo_editor131) = NEW cl_gui_textedit( parent = lo_split131 wordwrap_to_linebreak_mode = 0 ).
        ...
        lo_toolbar131->add_button( fcode = 'APPLY' icon = '@' butn_type = 0 text = 'Apply' quickinfo = 'Apply nested control' ).
      WHEN '132'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT132' ).
        DATA(lo_toolbar132) = NEW cl_gui_toolbar( parent = lo_root ).
        lo_toolbar132->add_button( fcode = 'REFRESH' icon = '@' butn_type = 0 text = 'Refresh controls' quickinfo = 'Refresh server control state' ).
        lo_toolbar132->set_position( left = 20 top = 20 width = 260 height = 40 ).
        write_line( io_session = io_session iv_text = |control refresh { mv_refresh }| ).
      WHEN '133'.
        lo_root = NEW cl_gui_custom_container( container_name = 'ROOT133' ).
        DATA(lo_editor133) = NEW cl_gui_textedit( parent = lo_root wordwrap_to_linebreak_mode = 0 ).
      ...
      WHEN '134'.
        ...
        lo_tree134->add_nodes( table_structure_name = 'TREEV_NODE' node_table = lt_nodes ).
        DATA(lo_editor134) = NEW cl_gui_textedit( parent = lo_root wordwrap_to_linebreak_mode = 0 ).
  ...
  METHOD zif_gg_report_v1~start_of_selection.
    ...
    write_line( io_session = io_session iv_text = |GUI control example { mv_mode }| ).
  ENDMETHOD.
  ...
  METHOD zif_gg_list_processing_v1~at_user_command.
    CASE mv_mode.
      WHEN '125'.
        IF iv_ucomm = 'RUN'.
          write_line( io_session = io_session iv_text = 'toolbar RUN dispatched by the server' ).
        ENDIF.
      WHEN '129'.
        IF iv_ucomm = 'SAVE_DOC'.
          write_line( io_session = io_session iv_text = 'document saved by the server' ).
        ENDIF.
      WHEN '130'.
        IF iv_ucomm = 'OPEN_DOC'.
          write_line( io_session = io_session iv_text = 'event OPEN_DOC dispatched by the server' ).
        ENDIF.
      WHEN '131'.
        IF iv_ucomm = 'APPLY'.
          write_line( io_session = io_session iv_text = 'nested control action applied by the server' ).
        ENDIF.
      WHEN '132'.
        IF iv_ucomm = 'REFRESH'.
