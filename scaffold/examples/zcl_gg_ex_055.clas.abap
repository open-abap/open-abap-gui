...
* zgg_ex_055.prog.abap. The host submits a supplied report and retains its list.
...
CLASS zcl_gg_ex_055 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_055' description = 'SUBMIT EXPORTING LIST TO MEMORY' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_055' ).
