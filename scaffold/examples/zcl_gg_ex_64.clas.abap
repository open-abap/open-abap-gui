CLASS zcl_gg_ex_64 DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_gg_ex_64 IMPLEMENTATION.
  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_64' description = 'Title status cursor and command feedback' ).
  ENDMETHOD.
