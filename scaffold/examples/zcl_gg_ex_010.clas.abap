...
* Feature 10, END-OF-PAGE. Counterpart of zgg_ex_010.prog.abap.
...
CLASS zcl_gg_ex_010 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_010' description = 'END-OF-PAGE' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_010' ).
  ...
  METHOD zif_gg_list_processing_v1~end_of_page.
    io_session->get_list( )->get_writer( )->write_field( VALUE #( text = 'footer' ) ).
  ENDMETHOD.
