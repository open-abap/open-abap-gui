...
* Feature 52, CALL SCREEN. Counterpart of zgg_ex_052.prog.abap.
...
CLASS zcl_gg_ex_052 IMPLEMENTATION.

  METHOD zif_gg_transaction_v1~get_transaction.
    rs_transaction = VALUE #( tcode = 'ZGG_EX_052' description = 'CALL SCREEN' ).
  ENDMETHOD.

  METHOD zif_gg_report_v1~start_of_selection.
    io_session->get_list( )->set_title( 'ZCL_GG_EX_052' ).
