...
CLASS zcl_gg_workbench_utility IMPLEMENTATION.
  ...
  METHOD render_styles.
    rv_html = ':root{--gg-work-area:#d5e6f3;--gg-work-surface:#fff;--gg-panel:#e3eff8;--gg-border-dark:#5b7790;--gg-border:#8daac4;--gg-input:#fff1a6;--gg-action:#fff3a3;--gg-row:26px;--gg-content-font:system-ui,Segoe UI,Tahoma,Arial,sans-serif;--gg-mono-font:ui-monospace,SFMono-Regular,Consolas,monospace;color-scheme:light}' &&
      ...
      '.wb-appbar{margin:0;padding:7px 14px;background:linear-gradient(#c9d9e9,#b2c7dc);border:0;border-bottom:1px solid var(--gg-border-dark);border-radius:0;color:#132d4b;display:flex;align-items:center;box-sizing:border-box}' &&
...
* that activates the function code and does not exclude it again.
  ...
  METHOD render_commandbar.
    ...
    rv_html = '<section class="wb-commandbar" role="toolbar" aria-label="Standard command toolbar" data-toolbar-scope="standard-command"><form id="' &&
