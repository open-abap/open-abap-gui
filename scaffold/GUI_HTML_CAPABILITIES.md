...
| `cl_gui_alv_grid` | rows, field catalog, selected rows, title | semantic table with headings | refresh/sort/filter toolbar commands | scalar row text where structured reflection is unavailable |
